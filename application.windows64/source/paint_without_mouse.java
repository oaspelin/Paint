...
public class paint_without_mouse extends PApplet {
...
public boolean checkRect(int x, int rectX, int rectW, int y, int rectY, int rectH) {
  if ((x>rectX && x<(rectX+rectW)) && (y>rectY && y<(rectY+rectH))) {
    return true;
  } else return false;
}
//checks if the given x and y coordinates are on an ellipse
public boolean checkEllipse(int x, int ellipseX, int ellipseW, int y, int ellipseY, int ellipseH) {
...
public void createRect(int x1, int x2, int y1, int y2) {
  if (x1<x2) {
...
public void createEllipse(int x1, int x2, int y1, int y2) {
  if (x1<x2) {
...
public void createLine(int x1, int x2, int y1, int y2) {
...
public void updateCursor() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "paint_without_mouse" };
    if (passedArgs != null) {
